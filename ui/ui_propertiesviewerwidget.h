...
public:
    ...
    void setupUi(QWidget *PropertiesViewerWidget)
    {
        if (PropertiesViewerWidget->objectName().isEmpty())
            PropertiesViewerWidget->setObjectName("PropertiesViewerWidget");
        ...
        allTextEdit->setObjectName("allTextEdit");
        ...
        itemAndMysticOrbsTextEdit->setObjectName("itemAndMysticOrbsTextEdit");
        ...
        rwAndMysticOrbsTextEdit->setObjectName("rwAndMysticOrbsTextEdit");
        ...
        socketablesTextEdit->setObjectName("socketablesTextEdit");
