...
public:
    ...
    void setupUi(QDialog *QD2CharRenamerClass)
    {
        if (QD2CharRenamerClass->objectName().isEmpty())
            QD2CharRenamerClass->setObjectName(QString::fromUtf8("QD2CharRenamerClass"));
        ...
        charNameLineEdit->setObjectName(QString::fromUtf8("charNameLineEdit"));
        ...
        QObject::connect(buttonBox, SIGNAL(rejected()), QD2CharRenamerClass, SLOT(reject()));
