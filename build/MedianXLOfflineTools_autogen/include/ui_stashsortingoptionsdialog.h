...
public:
    ...
    void setupUi(QDialog *StashSortingOptionsDialog)
    {
        if (StashSortingOptionsDialog->objectName().isEmpty())
            StashSortingOptionsDialog->setObjectName(QString::fromUtf8("StashSortingOptionsDialog"));
        ...
        itemQualityOrderingGroupBox->setObjectName(QString::fromUtf8("itemQualityOrderingGroupBox"));
        ...
        ascQualityRadioButton->setObjectName(QString::fromUtf8("ascQualityRadioButton"));
        ...
        descQualityRadioButton->setObjectName(QString::fromUtf8("descQualityRadioButton"));
        ...
        pageRangeGroupBox->setObjectName(QString::fromUtf8("pageRangeGroupBox"));
        pageRangeGroupBox->setGeometry(QRect(220, 10, 101, 91));
        firstPageSpinBox = new QDoubleSpinBox(pageRangeGroupBox);
        firstPageSpinBox->setObjectName(QString::fromUtf8("firstPageSpinBox"));
        ...
        firstPageLabel->setObjectName(QString::fromUtf8("firstPageLabel"));
        firstPageLabel->setGeometry(QRect(10, 30, 32, 16));
        lastPageSpinBox = new QDoubleSpinBox(pageRangeGroupBox);
        lastPageSpinBox->setObjectName(QString::fromUtf8("lastPageSpinBox"));
        ...
        diffTypesSpinBox->setObjectName(QString::fromUtf8("diffTypesSpinBox"));
        ...
        newRowGroupBox->setObjectName(QString::fromUtf8("newRowGroupBox"));
        newRowGroupBox->setGeometry(QRect(310, 110, 291, 91));
        newRowTierCheckBox = new QCheckBox(newRowGroupBox);
        newRowTierCheckBox->setObjectName(QString::fromUtf8("newRowTierCheckBox"));
        ...
        similarMiscItemsOnOnePageCheckBox->setObjectName(QString::fromUtf8("similarMiscItemsOnOnePageCheckBox"));
        ...
        eachTypeFromNewPageCheckBox->setObjectName(QString::fromUtf8("eachTypeFromNewPageCheckBox"));
        ...
        separateSacredCheckBox->setObjectName(QString::fromUtf8("separateSacredCheckBox"));
        ...
        QObject::connect(buttonBox, SIGNAL(accepted()), StashSortingOptionsDialog, SLOT(accept()));
        QObject::connect(buttonBox, SIGNAL(rejected()), StashSortingOptionsDialog, SLOT(reject()));
        QObject::connect(eachTypeFromNewPageCheckBox, SIGNAL(toggled(bool)), diffTypesSpinBox, SLOT(setEnabled(bool)));
        QObject::connect(eachTypeFromNewPageCheckBox, SIGNAL(toggled(bool)), diffTypesLabel, SLOT(setEnabled(bool)));
